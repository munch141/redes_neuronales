...
class Network(object):
    def __init__(self, sizes):
        ...
        weights    : arreglo de matrices que contiene, para cada capa, los pesos
                     de cada conexión en la red. Para una capa intermedia
                     'i', la posición (x,y) representa el peso del enlace entre
    ...
    def SGD(self, training_data, epochs, mini_batch_size, alpha):
        """
        Descenso del gradiente estocástico. Se divide el conjunto de
        ...
        epochs : cantidad de épocas para entrenar.
        mini_batch_size : tamaño de los lotes a tomar del conjunto de
                          entrenamiento.
